...
public class EmployeeValidationException extends IllegalArgumentException {
    public static final String INVALID_NAME = "El nombre no puede estar vacío o pasar de 50 caracteres.";
    public static final String INVALID_SURNAME = "El apellido no puede estar vacío o pasar de 50 caracteres.";
    public static final String INVALID_ROLE = "El rol no puede estar vacío o pasar de 50 caracteres.";
